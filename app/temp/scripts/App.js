	...
	_createClass(RevealOnScroll, [{
		...
		value: function createWaypoints() {
			...
			this.itemsToReveal.each(function () {
				...
				new Waypoint({
					element: currentItem, //Dom element to watch for
...
var StickyHeader = function () {
	...
	_createClass(StickyHeader, [{
		...
		value: function createHeaderWaypoint() {
			var that = this;
			new Waypoint({
				element: this.headerTriggerElement[0], //Dom element to watch for
...
var Modal = function () {
	...
	_createClass(Modal, [{
		...
		value: function openModal() {
			...
			return false; // Dont want the page to scroll back to the top
		}
	}, {
		key: "closeModal",
